...
Geleneksel makine mühendisliği disiplinlerini (FEA/CAE, CAD, Titreşim Analizi) yapay zeka, veri bilimi ve otomasyon ile birleştirerek akıllı ve optimize sistemler geliştirmeyi hedefliyorum.
...
* **Piezoelektrik Titreşim Sönümleme & Enerji Hasadı (Energy Harvesting)**
  * İçten yanmalı motorlarda (ICE) meydana gelen mekanik titreşimleri sönümleyen yenilikçi bir mekanik sistemin kavramsal tasarımı ve modellenmesi.
  * Akıllı malzemeler (PVDF/PZT matrisi) entegrasyonu ile kinetik enerjiyi elektrik enerjisine dönüştüren enerji hasadı mekanizmasının prototip düzeyinde kurgulanması.
  * Sistemin statik ve dinamik doğrulamalarının **SolidWorks**, **Ansys** (Statik Yapısal, Modal, Harmonik Yanıt) ve **COMSOL Multiphysics** (Piezoelektrik Modelleme) sonlu elemanlar yöntemi (FEM) simülasyon altyapısında gerçekleştirilmesi.

---

### 🛠️ Teknik Yetkinlikler & Araçlar

**Mühendislik Tasarım, Simülasyon & İmalat**
<p align="left">
  ...
  <img src="https://img.shields.io/badge/Hızlı_Prototipleme-3D_Baskı-orange?style=flat-square" />
</p>

**Programlama, Veri Bilimi & Yapay Zeka**
<p align="left">
...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/Teknik_Dokümantasyon-LaTeX-008080?style=flat-square&logo=latex&logoColor=white" />
</p>
...
* **Turkcell Geleceği Yazanlar:** Uygulama tabanlı Makine Öğrenimi, Derin Öğrenme, Doğal Dil İşleme (NLP) veri modellemeleri ve C# ile Nesne Yönelimli Programlama (OOP).
...
* **Endüstriyel Üretim & Saha:** Talaşlı imalat yöntemleri, kaynak teknikleri, sac metal şekillendirme ve mekanik bakım süreçleri üzerine saha gözlem ve pratikleri.
